...
web-браузера. Также сюда входят и обработчики событий. Они выполняют роль контроллеров (аналогия
из MVC), полностью отделяя игровую логику от особенностей среды исполнения.
